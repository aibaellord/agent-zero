...
(function() {
    ...
    class BaelHotkeyReference {
            ...
            return `
                <div class="hotkey-dialog">
                    ...
                    <div class="hotkey-body" id="hotkey-body">
                        ${Object.entries(this.shortcuts).map(([key, cat]) => `
        ...
        bindEvents() {
            // Close
            this.container.querySelector('#hotkey-close').addEventListener('click', () => this.hide());
        ...
        registerShortcut(category, keys, description) {
            ...
            if (this.visible) {
                this.container.querySelector('#hotkey-body').innerHTML = 
                    this.getTemplate().match(/<div class="hotkey-body"[^>]*>([\s\S]*?)<\/div>\s*<div class="hotkey-footer">/)?.[1] || '';
            }
        }
