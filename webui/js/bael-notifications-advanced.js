    ...
    class BaelNotificationsAdvanced {
        ...
        playSound(type) {
            ...
            freqs.forEach((freq, i) => {
                ...
                gainNode.gain.exponentialDecayTo && gainNode.gain.exponentialDecayTo(0.01, this.audioContext.currentTime + i * 0.1 + 0.2);
        ...
        show(options) {
            ...
            // Event handlers
            if (closable) {
                notification.querySelector('.bael-notif-close').addEventListener('click', (e) => {
                    e.stopPropagation();
                    this.dismiss(id);
                });
            }
        ...
        promise(promise, options = {}) {
            ...
            promise
                .then((result) => {
                    this.dismiss(id);
                    this.success(typeof options.success === 'function' 
        ...
        savePersistent(id, options) {
            ...
            localStorage.setItem('bael-notifications-persistent', JSON.stringify(this.persistent));
        }
        ...
        loadPersistent() {
            try {
                this.persistent = JSON.parse(localStorage.getItem('bael-notifications-persistent') || '[]');
