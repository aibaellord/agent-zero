    ...
    buildItemList() {
      this.items = [
        // Dashboards
        {
          ...
          subtitle: "Manage knowledge and memory",
          action: () => window.BaelMemoryDashboard?.show?.(),
        ...
        },
        {
          ...
          icon: "📊",
          title: "Agent Console",
          subtitle: "Monitor agent activity",
          action: () => window.BaelAgentConsole?.show?.(),
        ...
        },
        {
          ...
          subtitle: "AI reasoning visualization",
          action: () => window.BaelHeisenbergControl?.show?.(),
        ...
        },
        {
          ...
          action: () => window.BaelPerformanceDashboard?.show?.(),
        ...
        },
        {
          ...
          action: () => window.BaelSystemStatus?.show?.(),
        ...
        },
        {
          ...
          icon: "🧠",
          title: "AI Insights",
          subtitle: "Usage recommendations",
          action: () => window.BaelAIInsights?.show?.(),
        ...
        // Tools
        {
          ...
          action: () => window.BaelUnifiedSearch?.show?.(),
          shortcut: "Ctrl+/",
        },
        {
          category: "tools",
          ...
          action: () => window.BaelCommandCenter?.show?.(),
          shortcut: "Ctrl+K",
        },
        {
          category: "tools",
          ...
          action: () => window.BaelTemplateLibrary?.show?.(),
        ...
        },
        {
          ...
          action: () => window.BaelFavoritesHub?.show?.(),
        ...
        },
        {
          ...
          subtitle: "All keyboard shortcuts",
          action: () => window.BaelHotkeyReference?.show?.(),
          shortcut: "?",
        },
        ...
        },
        {
          ...
          action: () =>
            window.dispatchEvent(new CustomEvent("bael:open-scheduler")),
        },
        {
          category: "actions",
          icon: "🔄",
          title: "Restart Framework",
          subtitle: "Restart Agent Zero",
          action: () => window.dispatchEvent(new CustomEvent("bael:restart")),
        },
        ...
        // Power Systems
        {
          category: "power",
          icon: "👑",
          title: "Supremacy Panel",
          subtitle: "Master integration hub",
          action: () =>
            window.dispatchEvent(new CustomEvent("bael:open-supremacy")),
          shortcut: "Ctrl+Alt+S",
        },
        {
          category: "power",
          icon: "⚔️",
          title: "Domination Control",
          subtitle: "Agent control system",
          action: () =>
            window.dispatchEvent(new CustomEvent("bael:open-domination")),
          shortcut: "Ctrl+Alt+D",
        },
        {
          category: "power",
          ...
          subtitle: "All-seeing intelligence",
          action: () =>
            window.dispatchEvent(new CustomEvent("bael:open-omniscient")),
          shortcut: "Ctrl+Alt+O",
        },
        {
          category: "power",
          ...
          subtitle: "Maximum advantage extraction",
          action: () =>
            window.dispatchEvent(new CustomEvent("bael:open-exploit")),
          shortcut: "Ctrl+Alt+E",
        },
      ];
    }
