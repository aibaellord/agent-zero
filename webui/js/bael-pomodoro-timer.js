  ...
  class BaelPomodoroTimer {
    ...
    complete() {
      ...
      if (this.state.mode === "focus") {
        ...
        if (
          this.state.sessionsCompleted % this.settings.longBreakInterval ===
          0
        ) {
    ...
    updateDisplay() {
      ...
      this.container.querySelector(".timer-label").textContent =
        labels[this.state.mode];
      ...
      // Update stats
      this.container.querySelector("#sessions-count").textContent =
        this.state.sessionsCompleted;
      this.container.querySelector("#focus-time").textContent = this.formatTime(
        this.state.totalFocusTime,
      );
      this.container.querySelector("#streak").textContent = Math.floor(
        this.state.sessionsCompleted / this.settings.longBreakInterval,
      );
    }
