    ...
    class BaelThemeCustomizer {
        ...
        loadCurrentTheme() {
            try {
                ...
                if (saved) {
                    const themeId = saved;
                    this.currentTheme = this.themes.find(t => t.id === themeId) || this.defaultTheme;
                } else {
        ...
        renderColorInput(key, label, value) {
            ...
            if (value.startsWith('rgba')) {
                ...
                if (match) {
                    hexValue = '#' + [match[1], match[2], match[3]]
        ...
        selectTheme(id) {
            this.currentTheme = this.themes.find(t => t.id === id) || this.defaultTheme;
        ...
        updateColor(key, value) {
            ...
            const colorItem = this.container.querySelector(`[onchange*="'${key}'"]`)?.closest('.color-item');
            if (colorItem) {
