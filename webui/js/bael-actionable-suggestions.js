    ...
    class BaelActionableSuggestions {
        constructor() {
            ...
            this.actionTemplates = {
                code: [
                    { icon: '📝', text: 'Explain this code', prompt: 'Please explain what this code does:' },
                    { icon: '🐛', text: 'Debug this', prompt: 'Please help me debug this code:' },
                    { icon: '⚡', text: 'Optimize', prompt: 'Please optimize this code for better performance:' },
                    { icon: '📚', text: 'Add documentation', prompt: 'Please add detailed documentation to this code:' },
                    { icon: '🧪', text: 'Write tests', prompt: 'Please write unit tests for this code:' },
                    { icon: '🔄', text: 'Refactor', prompt: 'Please refactor this code to improve readability:' }
                ],
                text: [
                    { icon: '📖', text: 'Summarize', prompt: 'Please summarize the following text:' },
                    { icon: '✍️', text: 'Rewrite', prompt: 'Please rewrite this text more clearly:' },
                    { icon: '🌐', text: 'Translate', prompt: 'Please translate this to English:' },
                    { icon: '✨', text: 'Improve', prompt: 'Please improve the writing quality of:' },
                    { icon: '📋', text: 'Extract key points', prompt: 'Please extract the key points from:' }
                ],
                error: [
                    { icon: '🔧', text: 'Fix this error', prompt: 'Please help me fix this error:' },
                    { icon: '❓', text: 'Explain error', prompt: 'Please explain what this error means:' },
                    { icon: '🔍', text: 'Find cause', prompt: 'Please help me find the root cause of:' }
                ],
                file: [
                    { icon: '📂', text: 'Analyze file', prompt: 'Please analyze this file:' },
                    { icon: '📊', text: 'Extract data', prompt: 'Please extract and summarize data from:' },
                    { icon: '🔄', text: 'Convert format', prompt: 'Please help me convert this file:' }
                ],
                general: [
                    { icon: '💡', text: 'Brainstorm', prompt: 'Let\'s brainstorm ideas about' },
                    { icon: '📋', text: 'Create plan', prompt: 'Please create a step-by-step plan for' },
                    { icon: '🤔', text: 'Pros & Cons', prompt: 'Please analyze the pros and cons of' },
                    { icon: '📚', text: 'Learn more', prompt: 'Please explain more about' },
        ...
        detectContext(text) {
            ...
            } else if (text.includes('function') || text.includes('{') || text.includes('const ') || text.includes('let ')) {
                this.contextType = 'code';
            } else if (lowerText.includes('.json') || lowerText.includes('.csv') || lowerText.includes('.txt')) {
        ...
        renderBar(actions, showMore = false) {
            this.container.innerHTML = actions.map(action => `
        ...
        executeAction(prompt) {
            ...
            const chatInput = document.querySelector('textarea, [contenteditable="true"], #chat-input, .chat-input');
            if (chatInput) {
        ...
        showSuggestions(context) {
            const actions = this.actionTemplates[context] || this.actionTemplates.general;
