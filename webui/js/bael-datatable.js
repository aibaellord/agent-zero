...
(function () {
  ...
  class BaelDataTable {
     ...
     */
    _render(state) {
      const { container, searchable, pagination, selectable, pageSizeOptions } =
        state;
      ...
      state.paginationEl = container.querySelector(
        ".bael-datatable-pagination",
      );
    }
     ...
     */
    _renderHeader(state) {
      const { columns, selectable, sortColumn, sortDirection, resizable } =
        state;
