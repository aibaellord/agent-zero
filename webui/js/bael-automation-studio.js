...
(function() {
    ...
    class BaelAutomationStudio {
            ...
            const defaults = [
                {
                    ...
                    trigger: { type: 'manual' },
                    steps: [
                        { type: 'message', config: { text: 'Good morning! Let me prepare your daily briefing...' } },
                ...
                },
                {
                    ...
                    trigger: { type: 'manual' },
                    steps: [
                        { type: 'condition', config: { variable: 'topic', operator: 'exists' } },
        ...
        saveAutomations() {
            localStorage.setItem('bael_automations', JSON.stringify(this.automations));
        }
        ...
        deleteSelected() {
            ...
            this.automations = this.automations.filter(a => a.id !== this.selectedAutomation.id);
            this.saveAutomations();
            this.selectedAutomation = null;
            this.renderList();
            this.renderWorkflow();
            
            document.getElementById('automation-title').textContent = 'Select an automation';
        }
        ...
        async runSelected() {
            ...
            window.dispatchEvent(new CustomEvent('bael:automation-completed', {
        ...
        async executeStep(step) {
            switch (step.type) {
                case 'message':
                    window.dispatchEvent(new CustomEvent('bael:send-message', {
                ...
                case 'action':
                    window.dispatchEvent(new CustomEvent('bael:execute-action', {
        ...
        renderList() {
            ...
            list.innerHTML = this.automations.map(a => `
