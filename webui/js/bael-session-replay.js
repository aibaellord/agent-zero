...
(function() {
    ...
    class BaelSessionReplay {
        ...
        render() {
            ...
            list.innerHTML = this.recordings.map((rec, index) => {
        ...
        startRecordingTimer() {
            this.recordingInterval = setInterval(() => {
                ...
                const timeDisplay = this.indicator.querySelector('.recording-indicator-time');
        ...
        stopRecording() {
            ...
            // Save recording
            const name = prompt('Recording name:', `Session ${new Date().toLocaleDateString()}`);
            if (name !== null) {
                const recording = {
                    name,
                    timestamp: Date.now(),
                ...
                this.saveRecordings();
                this.toast(`Recording saved: ${this.recordedEvents.length} events`, 'success');
            }
