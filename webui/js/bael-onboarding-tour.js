...
(function () {
  ...
  class BaelOnboardingTour {
          ...
          steps: [
            {
              ...
              icon: "💬",
              content:
                "This is where you communicate with your AI agent. Type your message and press Enter to send.",
              position: "top",
            },
            {
              target: ".sidebar",
              ...
              icon: "📁",
              content:
                "Access settings, chat history, scheduled tasks, and more from the sidebar.",
              position: "right",
            },
            {
              target: null,
              ...
              icon: "🚀",
              content:
                'Double-tap <span class="tooltip-highlight">Ctrl</span> to open the Quick Launcher. Access any feature instantly!',
              position: "center",
            ...
            },
            {
              ...
              icon: "🔍",
              content:
                'Press <span class="tooltip-highlight">Ctrl+/</span> to search across everything - memory, files, chats, and commands.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "🎯",
              content:
                'Press <span class="tooltip-highlight">Ctrl+K</span> to open the Command Center. Execute any action with ease.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "⌨️",
              content:
                'Press <span class="tooltip-highlight">?</span> anytime to see all available keyboard shortcuts.',
              position: "center",
            },
          ],
        },
          ...
          steps: [
            {
              ...
              icon: "🧠",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+M</span> to manage your knowledge base and memories.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "📊",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+A</span> to monitor agent activity in real-time.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "📈",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+P</span> to track token usage, costs, and optimize performance.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "🔮",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+I</span> for AI-powered recommendations to improve your workflow.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "📋",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+T</span> to access and create prompt templates.',
              position: "center",
            },
          ],
        },
          ...
          steps: [
            {
              ...
              icon: "⚛️",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+H</span> to visualize AI reasoning and decision-making.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "⭐",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+B</span> to access your bookmarked items.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "📡",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+S</span> to monitor system health and module status.',
              position: "center",
            },
            {
              target: null,
              ...
              icon: "💾",
              content:
                'Press <span class="tooltip-highlight">Ctrl+Shift+W</span> to save and restore your workspace sessions.',
              position: "center",
            },
          ],
        },
    ...
    showTourMenu() {
      ...
      switch (choice) {
        case "1":
          this.startTour("quick");
          break;
        case "2":
          this.startTour("power");
          break;
        case "3":
          this.startTour("advanced");
          break;
      }
    }
  }
