...
(function() {
    ...
    class BaelWorkspaceLayouts {
        ...
        saveLayouts() {
            localStorage.setItem('bael_workspace_layouts', JSON.stringify(this.layouts));
        }
        ...
        render() {
            ...
            // Render presets
            presetGrid.innerHTML = presets.map(layout => this.renderLayoutCard(layout)).join('');
            ...
            if (this.layouts.length === 0) {
                ...
                customGrid.innerHTML = this.layouts.map(layout => this.renderLayoutCard(layout, true)).join('');
            }
        }
        ...
        applyLayout(layoutId) {
            ...
            window.dispatchEvent(new CustomEvent('bael:layout-changed', {
                detail: { layout }
            }));
