...
(function () {
  ...
  class BaelQuickNotes {
    ...
    render() {
      ...
      // Render active note
      if (this.activeNote) {
        this.container.querySelector(".note-title-input").value =
          this.activeNote.title;
        this.container.querySelector(".notes-textarea").value =
          this.activeNote.content;
        this.container
          .querySelector(".note-action.pin")
          .classList.toggle("active", this.activeNote.pinned);

        // Update color picker
        this.container.querySelectorAll(".color-option").forEach((opt) => {
          opt.classList.toggle(
            "active",
            opt.style.background === this.activeNote.color,
          );
        });
