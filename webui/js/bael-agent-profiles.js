...
(function() {
    ...
    class BaelAgentProfiles {
            ...
            return [
                {
                    ...
                    name: 'Default Agent',
                    icon: '🤖',
                    description: 'The standard Agent Zero configuration with balanced capabilities for general tasks.',
                    model: 'gpt-4',
                    builtin: true,
                ...
                },
                {
                    ...
                    name: 'Developer',
                    icon: '👨‍💻',
                    description: 'Optimized for coding tasks with enhanced code execution and debugging capabilities.',
                    model: 'gpt-4',
                    builtin: true,
                ...
                },
                {
                    ...
                    name: 'Researcher',
                    icon: '🔬',
                    description: 'Enhanced for research tasks with improved web search and document analysis.',
                    model: 'gpt-4',
                    builtin: true,
                ...
                },
                {
                    ...
                    name: 'Hacker',
                    icon: '💀',
                    description: 'Security-focused agent for penetration testing and security analysis.',
                    model: 'gpt-4',
                    builtin: true,
        ...
        async activateProfile(profileId) {
            try {
                ...
                if (response.ok) {
                    ...
                    // Dispatch event
                    window.dispatchEvent(new CustomEvent('bael:profile-changed', {
        ...
        editProfile(profileId) {
            window.dispatchEvent(new CustomEvent('bael:edit-profile', {
                detail: { profileId }
            }));
