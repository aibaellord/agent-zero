...
(function() {
    ...
    class BaelQuickLinks {
        constructor() {
            ...
            this.container = null;
            this.links = [];
            this.categories = ['All', 'Documentation', 'Tools', 'APIs', 'Reference', 'Other'];
        ...
        loadLinks() {
            try {
                ...
                if (saved) {
                    ...
                    this.links = [
                        { id: '1', title: 'Agent Zero Docs', url: 'https://github.com/frdel/agent-zero', category: 'Documentation', icon: '📚', pinned: true },
                        { id: '2', title: 'OpenAI API', url: 'https://platform.openai.com/docs', category: 'APIs', icon: '🤖', pinned: false },
                        { id: '3', title: 'Anthropic Docs', url: 'https://docs.anthropic.com', category: 'APIs', icon: '🧠', pinned: false },
                        { id: '4', title: 'Alpine.js', url: 'https://alpinejs.dev/docs', category: 'Reference', icon: '🏔️', pinned: false },
                        { id: '5', title: 'MDN Web Docs', url: 'https://developer.mozilla.org', category: 'Reference', icon: '📖', pinned: false }
                    ];
                    this.saveLinks();
                }
            } catch (e) {
        ...
        hideAddModal() {
            this.container.querySelector('.add-link-modal').classList.remove('visible');
        }
        ...
        saveNewLink() {
            ...
            const icon = this.container.querySelector('#link-icon').value.trim() || '🔗';
