    ...
    class BaelDrylink {
        ...
        async queryWithUrl(url) {
            ...
            if (chatInput) {
                ...
                // Try to auto-submit
                const submitBtn = document.querySelector('[type="submit"], button[x-on\\:click*="send"]');
                if (submitBtn) {
                    submitBtn.click();
                }
            }
        ...
        async handleFile(file) {
            ...
            try {
                ...
                if (response.ok) {
                    ...
                    // Dispatch event
                    window.dispatchEvent(new CustomEvent('bael:file-uploaded', {
                        detail: { file, result }
                    }));
                } else {
        ...
        async handleImage(file) {
            ...
            reader.onload = async (e) => {
                ...
                window.dispatchEvent(new CustomEvent('bael:image-dropped', {
                    detail: { file, dataUrl }
                }));
